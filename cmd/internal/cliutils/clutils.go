...
//
// The name argument contains the full name of this command (e.g., `buresu run`).
//
...
// when the argv[0] value does not identify any valid command.
